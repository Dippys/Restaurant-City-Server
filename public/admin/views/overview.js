...
export async function render(container) {
    ...
    container.textContent = '';
    container.append(h('h1', { class: 'rc-title' }, 'Server overview'), h('p', { class: 'rc-sub' }, `Server time: ${new Date(data.serverTime).toLocaleString('en-GB')}`), cards, actions, online);
}
