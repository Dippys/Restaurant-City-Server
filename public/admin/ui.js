...
export function buildMultiPlayerPicker() {
    ...
    const renderResults = () => {
        ...
        results.forEach((entry, index) => {
            const item = h('div', { class: 'rc-combobox-item', role: 'option' }, h('span', { class: 'rc-combobox-name' }, entry.label), h('span', { class: 'rc-combobox-id' }, entry.id));
