...
export function loadConfig(): ServerConfig {
  ...
  return {
    ...
    maxInFlightRequests: positiveInt(process.env.RC_MAX_IN_FLIGHT_REQUESTS, 64),
    maxInFlightRpcs: positiveInt(process.env.RC_MAX_IN_FLIGHT_RPCS, Math.min(16, dbPoolMax)),
